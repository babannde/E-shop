          ...
          {activeTab === 2 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                us at support@kiyira.com with your order number and a
          ...
          {activeTab === 4 && (
            <div className="mt-4">
              <p className="text-base text-gray-500">
                ...
                support@kiyira.com, or by calling us at +234 (912) 121-2020
                between the hours of 9am and 5pm EST, Monday through Sunday.
              </p>
            </div>
          )}
        </div>
